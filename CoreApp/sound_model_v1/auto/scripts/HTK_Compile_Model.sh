...
make_lexicon () {
	if [ -f "../../lexicon/voxforge_lexicon" ]; then
		echo "Found voxforge_lexicon"
	else
		echo "Error!! ../../lexicon/voxforge_lexicon not found!"
		return 1
	fi
	return 0
}
...
print_heading "Step 10 - Making Tied-State Triphones"
	HDMan -A -D -T 1 -b sp -n ./interim_files/fulllist -g ./input_files/global.ded -l logs/Step10_HDMan.flog ./interim_files/dict-tri ../../lexicon/voxforge_lexicon > logs/Step10_HDMan.log
	make_fulllist  
	make_treehed
	echo -e 'making hmm13\n'
